<?php
  ...
  // $_SESSION['join']がindex.phpの$_POSTと等しい

  // $_POSTが、もしくは$_SESSION['join']が存在しなければ中の処理を実行
  if (!isset($_SESSION['join'])) {
    // リダイレクト処理 (強制的にindex.phpへ遷移させる)
    // check.phpにユーザーが来たとき、$_SESSION['join']が存在しないということは
    // index.phpでデータの登録を行っていない不正アクセスユーザーということになるので。
            ...
            <table class="table table-striped table-condensed">
              <tbody>
                ...
                <tr>
                  ...
                  <td><div class="text-center"><img src="../member_picture/<?php echo htmlspecialchars($_SESSION['join']['image'], ENT_QUOTES, 'UTF-8'); ?>" width="100" height="100"></div></td>
                </tr>
              </tbody>
            </table>
